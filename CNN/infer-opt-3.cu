...
int main(int argc, char* argv[]) {
    ...
    int correct = 0;
    for (int t = 0; t < 9216; t += BATCH_SIZE) {
        ...
        // cudaMemcpy(pool1Output_h, pool1Output_d, pool1OutputBytes, cudaMemcpyDeviceToHost);
        ...
        //         {
        //             printf("%.6f ",pool1Output_h[k * POOL1_OUTPUT_SIZE * POOL1_OUTPUT_SIZE * F1 +
        //                  i * POOL1_OUTPUT_SIZE * POOL1_OUTPUT_SIZE + j]);   
        //             if (j%6==5) printf("\n");
        //         }
        //         printf("]\n");
        //     }
        ...
        // cudaMemcpy(pool2Output_h, pool2Output_d, pool2OutputBytes, cudaMemcpyDeviceToHost);
        // for (int k=0;k<BATCH_SIZE;k++)
        // {
        //     printf("batch size = %d\n\n", k);
        //     for (int i=0;i<F2;i++)
        ...
        //         {
        //             printf("%.4f ",pool2Output_h[k * POOL2_OUTPUT_SIZE * POOL2_OUTPUT_SIZE * F2 +
        //                  i * POOL2_OUTPUT_SIZE * POOL2_OUTPUT_SIZE + j]);   
        //             if (j%8==7) printf("\n");
        //         }
        //         printf("]\n");
        //     }
        ...
        // cudaMemcpy(fc2Output_h, fc2Output_d, fc2OutputBytes, cudaMemcpyDeviceToHost);
        // for (int k=0;k<BATCH_SIZE;k++)
        // {
        //     printf("batch size = %d\n\n", k);
        //     for (int i=0;i<FC2;i++) 
        //     {
        //         printf("%.4f ",fc2Output_h[k*FC2+i]);
        //         if (i%7==6) printf("\n");
        //     }
        // }
